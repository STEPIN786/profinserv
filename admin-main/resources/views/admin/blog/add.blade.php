                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleSelectGender1">Blog Category</label>
                                        <select class="form-control" name="blog_cat_id" id="exampleSelectGender1" required>
                                            <option value="">Select Catagory</option>
                                            @foreach ($Blogcategory as $category)
                                                <option value="{{ $category->id }}" {{ (isset($Blog->blog_cat_id) && ($Blog->blog_cat_id==$category->id)) ? 'selected' : '' }}>
                                                    {{ $category->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" name="id" id="exampleInputName4" value="{{ $Blog->id }}" placeholder="id">
                                        <input type="text" class="form-control" name="title" id="exampleInputName1" value="{{ $Blog->title }}" placeholder="Enter Title">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-xs-12">
                                            <input type="text" name="thumb_image" class="form-control file-upload-info" disabled placeholder="Upload Image">
                                    ...
                                    <img src="<?php echo asset('upload/blog/' . $Blog->thumb_image); ?>" width="200" class="table-user-thumb" alt="">
                                </div>
                                @endif
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-xs-12">
                                            <input type="text" name="img_name" class="form-control file-upload-info" disabled placeholder="Upload Image">
                                            <span class="input-group-append">
                                                <button class="file-upload-browse btn btn-primary" type="button">{{ __('Upload') }}</button>
                                            </span>
                                        </div>
                                    ...
                                    <img src="<?php echo asset('upload/blog/' . $Blog->img_name); ?>" width="200" class="table-user-thumb" alt="">
                                </div>
                            </div>
