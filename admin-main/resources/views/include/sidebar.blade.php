    ...
    <div class="sidebar-header">
        ...
        <a class="header-brand" href="{{ route('dashboard') }}">
            ...
            <div class="logo-img d-flex">
                ...
                <img height="30" src="{{ asset('img/logo.png') }}" class="header-brand-img" title="ABF">
    ...
    <div class="sidebar-content">
        ...
        <div class="nav-container">
            ...
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item {{ $segment2 == 'blogcategory' ? 'active open' : '' }} has-sub">

                    <a href="javascript:void(0)"><i class="ik ik-box"></i><span>{{ __('Blog Category') }}</span></a>

                    <div class="submenu-content">

                        <a href="{{ route('blog-cat-list') }}" class="menu-item {{ $segment2 == 'blogcategory' ? 'active' : '' }}">{{ __('List Blog Category') }}</a>

                    </div>
                </div>


                <div class="nav-item {{ $segment2 == 'blog' ? 'active open' : '' }} has-sub">
                ...
                @if (false)
                <div class="nav-item {{ $segment2 == 'video' ? 'active open' : '' }} has-sub">
                    <a href="javascript:void(0)"><i class="ik ik-box"></i><span>{{ __('Video') }}</span></a>
                    <div class="submenu-content">
                        <a href="{{ route('video-list') }}" class="menu-item {{ $segment2 == 'video' ? 'active' : '' }}">{{ __('List Videos') }}</a>
                    </div>
                </div>
                @endif
                <div class="nav-item {{ $segment2 == 'comment' ? 'active open' : '' }} has-sub">
                    <a href="javascript:void(0)"><i class="ik ik-box"></i><span>{{ __('Blog Comments') }}</span></a>
                    <div class="submenu-content">
                        <a href="{{ route('comment-list') }}" class="menu-item {{ $segment2 == 'comment' ? 'active' : '' }}">{{ __('List Comments') }}</a>
                    </div>
                </div>
